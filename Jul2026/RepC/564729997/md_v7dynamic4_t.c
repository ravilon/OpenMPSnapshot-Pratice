...
void forces(int npart, double x[], double f[], double side, double rcoff)
{
  ...
  #pragma omp parallel for schedule(dynamic, 4) default(none) private(i,j,xi,yi,zi,fxi,fyi,fzi,xx,yy,zz,rd,rrd,rrd2,rrd3,rrd4,rrd6,rrd7,r148,forcex,forcey,forcez) shared(x,f,npart,side,sideh,rcoffs) reduction(+:vir,epot)
