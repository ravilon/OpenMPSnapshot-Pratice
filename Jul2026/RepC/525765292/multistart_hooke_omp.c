...
int main(int argc, char *argv[])
{
	...
	/* user given thread number */
	int thread_count = strtol(argv[1], NULL, 10);
	/* Each thread needs to have it's own arrays, loop and trial index, and the storing variavle fx */
	#pragma omp parallel for num_threads(thread_count) private(i, trial, startpt, endpt, fx, jj)
