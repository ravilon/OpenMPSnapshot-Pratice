  ...
  if (omp_in_final() || ort_task_throttling())
    {
      ...
      /* byvalue variables */
      double (* _fip_M2) = M2, (* M2) = _fip_M2;
      double (* _fip_A) = A, (* A) = _fip_A;
      double (* _fip_B) = B, (* B) = _fip_B;
      unsigned _fip_QuadrantSize = QuadrantSize, QuadrantSize = _fip_QuadrantSize;
      unsigned _fip_RowWidthA = RowWidthA, RowWidthA = _fip_RowWidthA;
      unsigned _fip_RowWidthB = RowWidthB, RowWidthB = _fip_RowWidthB;
    ...
    /* (l1130) #pragma omp task untied */
    {
      ...
      _tenv->A = A;
      _tenv->B = B;
      _tenv->QuadrantSize = QuadrantSize;
      _tenv->RowWidthA = RowWidthA;
      _tenv->RowWidthB = RowWidthB;
      _tenv->Depth = Depth;
  ...
  if (omp_in_final() || ort_task_throttling())
    {
      ...
      /* byvalue variables */
      double (* _fip_M5) = M5, (* M5) = _fip_M5;
      double (* _fip_S1) = S1, (* S1) = _fip_S1;
      double (* _fip_S5) = S5, (* S5) = _fip_S5;
      unsigned _fip_QuadrantSize = QuadrantSize, QuadrantSize = _fip_QuadrantSize;
      int _fip_Depth = Depth, Depth = _fip_Depth;
  ...
  if (omp_in_final() || ort_task_throttling())
    {
      ...
      /* byvalue variables */
      double (* _fip_T1sMULT) = T1sMULT, (* T1sMULT) = _fip_T1sMULT;
      double (* _fip_S2) = S2, (* S2) = _fip_S2;
      double (* _fip_S6) = S6, (* S6) = _fip_S6;
      unsigned _fip_QuadrantSize = QuadrantSize, QuadrantSize = _fip_QuadrantSize;
      int _fip_Depth = Depth, Depth = _fip_Depth;
  ...
  if (omp_in_final() || ort_task_throttling())
    {
      ...
      /* byvalue variables */
      double (* _fip_C22) = C22, (* C22) = _fip_C22;
      double (* _fip_S3) = S3, (* S3) = _fip_S3;
      double (* _fip_S7) = S7, (* S7) = _fip_S7;
      unsigned _fip_QuadrantSize = QuadrantSize, QuadrantSize = _fip_QuadrantSize;
      unsigned _fip_RowWidthC = RowWidthC, RowWidthC = _fip_RowWidthC;
      int _fip_Depth = Depth, Depth = _fip_Depth;
  ...
  if (omp_in_final() || ort_task_throttling())
    {
      ...
      /* byvalue variables */
      double (* _fip_C) = C, (* C) = _fip_C;
      double (* _fip_A12) = A12, (* A12) = _fip_A12;
      double (* _fip_B21) = B21, (* B21) = _fip_B21;
      unsigned _fip_QuadrantSize = QuadrantSize, QuadrantSize = _fip_QuadrantSize;
      unsigned _fip_RowWidthC = RowWidthC, RowWidthC = _fip_RowWidthC;
      unsigned _fip_RowWidthA = RowWidthA, RowWidthA = _fip_RowWidthA;
      unsigned _fip_RowWidthB = RowWidthB, RowWidthB = _fip_RowWidthB;
  ...
  if (omp_in_final() || ort_task_throttling())
    {
      ...
      /* byvalue variables */
      double (* _fip_C12) = C12, (* C12) = _fip_C12;
      double (* _fip_S4) = S4, (* S4) = _fip_S4;
      double (* _fip_B22) = B22, (* B22) = _fip_B22;
      unsigned _fip_QuadrantSize = QuadrantSize, QuadrantSize = _fip_QuadrantSize;
      unsigned _fip_RowWidthC = RowWidthC, RowWidthC = _fip_RowWidthC;
      unsigned _fip_RowWidthB = RowWidthB, RowWidthB = _fip_RowWidthB;
      int _fip_Depth = Depth, Depth = _fip_Depth;
  ...
  if (omp_in_final() || ort_task_throttling())
    {
      ...
      /* byvalue variables */
      double (* _fip_C21) = C21, (* C21) = _fip_C21;
      double (* _fip_A22) = A22, (* A22) = _fip_A22;
      double (* _fip_S8) = S8, (* S8) = _fip_S8;
      unsigned _fip_QuadrantSize = QuadrantSize, QuadrantSize = _fip_QuadrantSize;
      unsigned _fip_RowWidthC = RowWidthC, RowWidthC = _fip_RowWidthC;
      unsigned _fip_RowWidthA = RowWidthA, RowWidthA = _fip_RowWidthA;
      int _fip_Depth = Depth, Depth = _fip_Depth;
