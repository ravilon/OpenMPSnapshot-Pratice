...
plasma_unused( amn );
#pragma omp task depend (in:amn[0]) depend (inout:a00[0])
{
int l = 1;
l++;
}
...
#pragma omp task depend (in:ipiv[0:A.m]) depend (inout:a00[0:ma00*na00]) depend (inout:a10[0:lda10*nva10])
{
...
plasma_complex64_t *amn = A(m, n);
plasma_unused( amn );
#pragma omp task depend (in:a00[0]) depend (inout:amn[0])
{
int l = 1;
l++;
}
...
#pragma omp task depend (in:ipiv[0:A.n]) depend (inout:a00[0]) depend (inout:a01[0])
{
