...
#pragma omp parallel num_threads( num_threads ) default( none ) shared( plasma ) firstprivate( A, lda, n, nb, num_threads, shift, tau, uplo, V, Vblksiz, wantz, work, progress_size )
{
