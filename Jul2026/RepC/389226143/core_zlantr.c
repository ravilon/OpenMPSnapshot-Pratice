...
{
#pragma omp task depend(in:A[0:lda*n]) depend(out:value[0:1])
{
...
switch (norm) {
case PlasmaOneNorm:
#pragma omp task depend(in:A[0:lda*n]) depend(out:value[0:n])
{
if (sequence->status == PlasmaSuccess) {
if (uplo == PlasmaUpper) {
...
break;
case PlasmaInfNorm:
#pragma omp task depend(in:A[0:lda*n]) depend(out:value[0:m])
{
if (sequence->status == PlasmaSuccess) {
if (uplo == PlasmaUpper) {
if (diag == PlasmaNonUnit) {
