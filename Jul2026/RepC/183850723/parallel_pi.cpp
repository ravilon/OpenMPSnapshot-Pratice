...
//#pragma omp parallel private(t,s,a,av,den,i,kq1,kq2,kq3,kq4,num,t1,v)
//#pragma omp parallel for ordered reduction(+:s) private(a,av,den,i,kq1,kq2,kq3,kq4,num,t,t1,v)
...
//printf("%f,",sum);
//printf("%5.1f%%\r",(float)a/3.0f/(float)N*100.0f);
