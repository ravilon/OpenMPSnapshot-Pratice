...
Autor:                  Kilian Armas Prez
Titulacin:             Ingeniera Informtica
Asignatura:             Arquitectura de Computadores
Fecha:                  09/07/2023
Descripcin:            Implementacin del algoritmo de multiplicacin de
                        matrices con nmeros en coma flotante haciendo uso
                        de la librera de programacin paralela OpenMP.
===========================================================================
*/
...
#define M 1000          // Nmero de filas de la matriz A y nmero de filas de la matriz C
#define N 1000          // Nmero de columnas de la matriz A y nmero de filas de la matriz B
#define P 1000          // Nmero de columnas de la matriz B y nmero de columnas de la matriz C
...
int main() {
    ...
    // Imprimir el tiempo de ejecucin
