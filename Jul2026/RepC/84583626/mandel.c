/*
 * Programmation Parallle - Avril 2012
 * Polytech'Paris 
 * Universit Pierre et Marie Curie
 * Calcul de l'ensemble de Mandelbrot, Version squentielle
 */
...
/**
 *  Sauvegarde le tableau de donnes au format rasterfile
 ...
 * \end{array}\right.
 * \f]
 * le nombre d'itrations que la suite met pour diverger est le
...
unsigned char xy2color(double a, double b, int prof) {
	...
	x = y = 0.;
	for( i=0; i<prof; i++) {
		/* garder la valeur prcdente de x qui va etre ecrase */
		temp = x;
