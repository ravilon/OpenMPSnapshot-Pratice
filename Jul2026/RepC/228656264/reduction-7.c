...
#pragma acc parallel num_gangs(32) num_workers(32) vector_length(32) copyin(arr)
{
#pragma acc loop gang reduction(+:res)
for (j = 0; j < 32; j++)
{
...
#pragma acc parallel num_gangs(32) num_workers(32) vector_length(32) private(res) copyout(out)
{
...
#pragma acc parallel num_gangs(32) num_workers(32) vector_length(32) private(acc) copyin(ina, inb) copyout(out)
{
...
#pragma acc parallel num_gangs(32) num_workers(32) vector_length(32) private(res) copyin(arr) copyout(out)
{
