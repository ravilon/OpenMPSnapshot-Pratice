...
template <typename VB> struct triangle {
...
template <typename VB> class aabb {
public:
...
template <typename VB, typename RT> class raytracer {
public:
  raytracer() {};
  ~raytracer() {};
...
template <typename VB> inline bool aabb<VB>::aabb_test(const ray &ray) const {
