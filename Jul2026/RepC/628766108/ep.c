...
#pragma acc parallel num_gangs((blksize+255)/256) num_workers(1) vector_length(256)  present(xx[0:blksize*2*NK],qq[0:blksize*NQ]) 
{ 
  ...
  //  printf("sx=%f,sy=%f\n", sx, sy);
  #pragma acc parallel num_gangs(NQ) num_workers(4) vector_length(32)  present(q[0:NQ],qq[0:blksize*NQ])
  {
