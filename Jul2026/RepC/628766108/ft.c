...
static void init_ui(int d1, int d2, int d3)
{
 ...
 #pragma acc parallel num_gangs(d3) num_workers(8) vector_length(128)  present(u0_real,u0_imag,u1_real,u1_imag,twiddle)
 {
...
static void cffts1_pos(int is, int d1, int d2, int d3)
{
 ...
 #pragma acc parallel num_gangs(d3) vector_length(128)  present(gty1_real,gty1_imag,gty2_real,gty2_imag, u1_real,u1_imag,u_real,u_imag) 
 {
  #pragma acc loop gang
  for (k = 0; k < d3; k++) {
   #pragma acc loop vector
...
static void cffts3_pos(int is, int d1, int d2, int d3)
{
  ...
  #pragma acc parallel num_gangs(d2) vector_length(128)  present(gty1_real,gty1_imag,gty2_real,gty2_imag, u0_real,u0_imag,u1_real,u1_imag,u_real,u_imag) 
 {
  #pragma acc loop gang
  for (j = 0; j < d2; j++) {
    #pragma acc loop vector
...
static void cffts3_neg(int is, int d1, int d2, int d3)
{
  ...
  #pragma acc parallel num_gangs(d2) vector_length(128)  present(gty1_real,gty1_imag,gty2_real,gty2_imag, u1_real,u1_imag,u_real,u_imag) 
  {
  #pragma acc loop gang
  for (j = 0; j < d2; j++) {
    #pragma acc loop vector
...
//#pragma acc update host(u1_real,u1_imag)
#pragma acc parallel num_gangs(1) num_workers(1)  vector_length(1024) present(u1_real,u1_imag)
{
