...
double degreeSize = 0.01;	// 1ȸ ȸ
double degreeSum = 0;		// sum 
double degreeMax = 5;		// ִ ȸ
double degreeMin = -degreeMax;		// ִ ȸ

cv::Point checkPt[20];		// üũ   ̸   
int checkNum = 20;			// 迭 
int sliceNum = 21;			//  
...
// ã ٸ 𼭸  մϴ.
//  𼭸 ̸Ʈ  մ 𼭸 ȸ  մϴ.
angleFindingHelper angleRef[3];	//  𼭸 ȸ  մϴ.
