...
#ifndef LBT__POPULATIONS__POPULATION_BASE_TEST
#define LBT__POPULATIONS__POPULATION_BASE_TEST
#pragma once
...
is_success &= lbt::math::isAlmostEqualEpsAbs(result, static_cast<T>(expected_result));
++i;
}
}
}
...
#endif // LBT__POPULATIONS__POPULATION_BASE_TEST
