...
#ifndef LBT__UNITS__REYNOLDS_NUMBER
#define LBT__UNITS__REYNOLDS_NUMBER
#pragma once
    ...
    */
    class ReynoldsNumber {
      public:
        ...
        */
        explicit constexpr ReynoldsNumber(long double const value) noexcept
          : value{value} {
          return;
        }
...
#endif // LBT__UNITS__REYNOLDS_NUMBER
