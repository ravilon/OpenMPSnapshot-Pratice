...
#ifndef LBT__CONSTEXPR_MATH__IS_ALMOST_EQUAL_EPS_REL
#define LBT__CONSTEXPR_MATH__IS_ALMOST_EQUAL_EPS_REL
#pragma once
...
auto const diff {math::abs(a-b)};
auto const sum {math::abs(a+b)};
...
#endif // LBT__MATH__IS_ALMOST_EQUAL_EPS_REL
