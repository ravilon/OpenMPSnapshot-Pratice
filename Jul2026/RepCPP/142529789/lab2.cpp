...
//ofstream Ddout("/Users/ludmila/Desktop//PVGermgolts/PVGermgolts/Discrepancy.dat");
//    ofstream Dout("/Users/ludmila/Desktop//PVGermgolts/PVGermgolts/Solution.dat");
//    
//    for (int i = 0; i <= n; i++)
//        for (int j = 0; j <= n; j++)
//            Dout<<xGrid[i]<<endl;
...
if (vyvod) cout << "k = " << k << ";    = " << MNormDlt(n + 1, f, F) << endl;*/
