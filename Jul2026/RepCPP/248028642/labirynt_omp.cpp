// Karol Dzialowski Lab 8
// Labirynt w OpenMP
// Rekurencja task i taskwait
// Pobieranie licznika: pragma omp_critical
// Tablice mutex zastepujemy omp_lock_t i funkcjami
...
int getThreadIndex() {
  ...
  // Ta sekcja może być wykonywana tylko przez jeden wątek w danym czasie.
...
void mazeRun(int start_position_x, int start_position_y) {
  ...
  // Czekanie aż wszystkie dzieci zakończą działanie.
  #pragma omp taskwait
}
...
int main() {
    ...
    // Używam pragmy omp parallel i pragmy omp signle jak w tutorialu:
