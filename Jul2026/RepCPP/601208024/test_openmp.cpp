...
#pragma omp parallel num_threads(amountOfThreads)                     shared(iterationCounts, critCurrentEnd, prevPrevCritEnd,          isEndOfAlgo, Atmp, y, tauY, xCurr, xNext, matrixA, b,      bNorm, yNorm, numeratorTau, denominatorTau)
  {
