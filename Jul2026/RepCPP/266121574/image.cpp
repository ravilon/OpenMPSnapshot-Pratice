//
// Created by atharva on 06/06/20.
// Code heavily borrowed from intel samples. Modifications include speeding up reading
//

#include "image.h"

//_mm_malloc is available for intel compilers,
// GNU GCC users can use aligned_Alloc or posix_memalloc(talking about ubuntu) for aligned memory allocation
template<typename P>
