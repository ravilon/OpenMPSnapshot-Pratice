...
#pragma omp allocate(SharedMemVariableSharingSpace)                             allocator(omp_pteam_mem_alloc)
[[clang::loader_uninitialized]] static void **SharedMemVariableSharingSpacePtr;
#pragma omp allocate(SharedMemVariableSharingSpacePtr)                          allocator(omp_pteam_mem_alloc)
