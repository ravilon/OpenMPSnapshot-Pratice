...
#pragma omp parallel shared(sortedVec, val, l, r, isValToTheRight, indexFound) default(none)	// compile error if a local variable is not mentioned in shared(...) or private(...)
{
...
#pragma omp parallel shared(l, r, thrdsPos, isValToTheRight, sortedVec, val) default(none)	// compile error if a local variable is not mentioned in shared(...) or private(...)
{
const unsigned thrdID = omp_get_thread_num();
