...
void rectangleLUij(TYPE* A, const int m, const int n, const int i0, const int j0) // 2.9 
{
	int min = MIN(m - 1, n);
	for (int i = 0; i < min; ++i)
	{
...
void rectangleLUijParallel(TYPE* A, const int m, const int n, const int i0, const int j0) // 2.9 
{
	int min = MIN(m - 1, n);
	for (int i = 0; i < min; ++i)
	{
