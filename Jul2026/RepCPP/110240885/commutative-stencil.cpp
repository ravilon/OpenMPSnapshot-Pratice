...
#pragma oss task commutative(matrix[i][j]) commutative(matrix[i-1][j]) commutative(matrix[i+1][j]) commutative(matrix[i][j-1]) commutative(matrix[i][j+1]) label("update cross")
{
blockUpdate(i, j);
blockUpdate(i-1, j);
blockUpdate(i+1, j);
...
#pragma oss task commutative(matrix[i][j]) commutative(matrix[i][j-1]) commutative(matrix[i][j+1]) label("update circumflex")
{
blockUpdate(i, j);
blockUpdate(i, j-1);
blockUpdate(i, j+1);
...
#pragma oss task commutative(matrix[i-1][j-1]) commutative(matrix[i+1][j+1]) label("update spread")
{
blockUpdate(i-1, j-1);
blockUpdate(i+1, j+1);
}
...
#pragma oss task commutative(matrix[i-1][j-1]) commutative(matrix[i+1][j+1]) commutative(matrix[i+1][j-1]) commutative(matrix[i-1][j+1]) label("update edges")
{
blockUpdate(i-1, j-1);
blockUpdate(i+1, j+1);
blockUpdate(i+1, j-1);
...
#pragma oss task commutative(matrix[i-1][j]) commutative(matrix[i+1][j]) commutative(matrix[i][j-1]) commutative(matrix[i][j+1]) label("update empty cross")
{
blockUpdate(i-1, j);
blockUpdate(i+1, j);
blockUpdate(i, j-1);
