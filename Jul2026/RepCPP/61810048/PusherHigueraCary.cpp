...
#pragma omp target is_device_ptr( /* to: */                                charge /* [istart:particle_number] */ )  is_device_ptr( /* tofrom: */                                           momentum_x /* [istart:particle_number] */,              momentum_y /* [istart:particle_number] */,              momentum_z /* [istart:particle_number] */,              position_x /* [istart:particle_number] */,              position_y /* [istart:particle_number] */,              position_z /* [istart:particle_number] */ )
#pragma omp teams distribute parallel for
#elif defined(SMILEI_ACCELERATOR_GPU_OACC)
const int istart_offset   = istart - ipart_buffer_offset;
const int particle_number = iend - istart;

#pragma acc parallel present(Ex [0:nparts],     Ey [0:nparts],     Ez [0:nparts],     Bx [0:nparts],     By [0:nparts],     Bz [0:nparts],     invgf [0:nparts])  deviceptr(position_x,                                            position_y,                                            position_z,                                            momentum_x,                                            momentum_y,                                            momentum_z,                                            charge)
