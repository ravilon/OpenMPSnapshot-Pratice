...
#pragma acc parallel present( Jx_s[0:Jx_size],      Jy_s[0:Jy_size],  Jz_s[0:Jz_size],    rho_s[0:rho_size] )  
{
#endif
if (Jx_s) {
...
#ifdef SMILEI_ACCELERATOR_GPU_OACC
#pragma acc parallel  present(Ex[0:nparts],Ey[0:nparts],Ez[0:nparts],  Bx[0:nparts], By[0:nparts], Bz[0:nparts],  deltaold[0:3*nparts],  iold[0:3*nparts],  gamma[0:nparts])  deviceptr(  position_x,position_y,position_z,  momentum_x,momentum_y,momentum_z,  charge,weight,tau,chi)
{
#pragma acc loop seq
#endif
...
#ifdef SMILEI_ACCELERATOR_GPU_OACC
#pragma acc parallel   present(Epart[0:nparts*3], Bpart[0:nparts*3],  gamma[0:nparts],  iold[0:nparts*nDim_particle],  deltaold[0:nparts*nDim_particle])  deviceptr(  position_x,position_y,position_z,  momentum_x,momentum_y,momentum_z,  charge,weight,tau,chi)
{
...
//    #pragma acc kernels
#pragma acc serial   present(Epart[0:nparts*3], Bpart[0:nparts*3],  gamma[0:nparts],  iold[0:nparts*nDim_particle],  deltaold[0:nparts*nDim_particle],  thetaold[0:nparts_thetaold])  deviceptr(  position_x,position_y,position_z,  momentum_x,momentum_y,momentum_z,  charge,weight,tau,chi)
{
//int nb_deleted_photon;
