...
void PusherBorisNR::operator()( Particles &particles, SmileiMPI *smpi, int istart, int iend, int ithread, int ipart_buffer_offset )
{
    ...
    #pragma acc parallel present(Ex [0:nparts],     Ey [0:nparts],     Ez [0:nparts],     Bx [0:nparts],     By [0:nparts],     Bz [0:nparts]),     deviceptr(position_x,                                            position_y,                                            position_z,                                            momentum_x,                                            momentum_y,                                            momentum_z,                                            charge)
