                                            ...
                                            int )
{
    ...
    #pragma omp target map( to                                                      : i_domain_begin, j_domain_begin )                      is_device_ptr /* map */ ( /* to: */                                         position_x /* [first_index:npart_range_size] */,  position_y /* [first_index:npart_range_size] */ )
    ...
    #pragma acc parallel present(ELoc [first_index:interpolation_range_size], BLoc [first_index:interpolation_range_size], iold [first_index:interpolation_range_size], delta [first_index:interpolation_range_size], Ex2D [0:sizeofEx], Ey2D [0:sizeofEy], Ez2D [0:sizeofEz], Bx2D [0:sizeofBx], By2D [0:sizeofBy], Bz2D [0:sizeofBz]) deviceptr(position_x, position_y)               copyin(d_inv_[0:2])
    ...
    #pragma acc update device(this)
    size_t interpolation_range_size = ( last_index + 1 * nparts ) - first_index;
    #pragma acc parallel present(ELoc [first_index:interpolation_range_size], BLoc [first_index:interpolation_range_size], BypartBTIS3 [first_index:interpolation_range_size], BzpartBTIS3 [first_index:interpolation_range_size], iold [first_index:interpolation_range_size], delta [first_index:interpolation_range_size], Ex2D [0:sizeofEx], Ey2D [0:sizeofEy], Ez2D [0:sizeofEz], Bx2D [0:sizeofBx], By2D [0:sizeofBy], Bz2D [0:sizeofBz], By2D_mBTIS3 [0:sizeofEz], Bz2D_mBTIS3 [0:sizeofEy]) deviceptr(position_x, position_y)               copyin(d_inv_[0:2])
    #pragma acc loop gang worker vector
#endif
        for( int ipart=*istart ; ipart<*iend; ipart++ ) {
