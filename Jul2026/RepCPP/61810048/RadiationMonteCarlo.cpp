...
#pragma acc data present(Ex[istart:np],Ey[istart:np],Ez[istart:np], Bx[istart:np],By[istart:np],Bz[istart:np],  radiation_tables.integfochi_.data_[0:radiation_tables.integfochi_.size_],  radiation_tables.xi_.data_[0:radiation_tables.xi_.size_],  radiation_tables.xi_.axis1_min_[0:radiation_tables.xi_.dim_size_[0]])  deviceptr(momentum_x,momentum_y,momentum_z,position_x,  position_y,position_z,charge,weight,tau,chi,  photon_position_x,  photon_position_y,  photon_position_z,  photon_momentum_x,  photon_momentum_y,  photon_momentum_z,  photon_weight,  photon_charge,  photon_chi_array,  photon_tau,  photon_cell_keys  )
{
#pragma acc parallel  present(Ex[istart:np],Ey[istart:np],Ez[istart:np], Bx[istart:np],By[istart:np],Bz[istart:np],  radiation_tables.integfochi_.data_[0:radiation_tables.integfochi_.size_],  radiation_tables.xi_.data_[0:radiation_tables.xi_.size_],  radiation_tables.xi_.axis1_min_[0:radiation_tables.xi_.dim_size_[0]])  deviceptr(position_x,  position_y,  position_z,  momentum_x,momentum_y,momentum_z,charge,weight,tau,chi,  photon_position_x,  photon_position_y,  photon_position_z,  photon_momentum_x,  photon_momentum_y,  photon_momentum_z,  photon_weight,  photon_charge,  photon_chi_array,  photon_tau,  photon_cell_keys,  )
{
...
#pragma acc loop gang worker vector  private(random_number, seed_curand_1, seed_curand_2)  reduction(+:radiated_energy_loc)
...
#else
int np = iend-istart;
#pragma acc parallel present(Ex[istart:np],Ey[istart:np],Ez[istart:np], Bx[istart:np],By[istart:np],Bz[istart:np])  deviceptr(momentum_x,momentum_y,momentum_z, charge,weight,chi)  private(gamma)
{
