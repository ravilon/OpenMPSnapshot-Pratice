...
#if defined( SMILEI_ACCELERATOR_GPU_OMP )
#pragma omp target enter data map( alloc  : byte_array [0:a_count * an_object_size] )
#elif defined( SMILEI_ACCELERATOR_GPU_OACC )
...
const unsigned char* byte_array = static_cast<const unsigned char*>( a_host_pointer );
#if defined( SMILEI_ACCELERATOR_GPU_OMP )
#pragma omp target enter data map( to  : byte_array [0:a_count * an_object_size] )
#elif defined( SMILEI_ACCELERATOR_GPU_OACC )
...
unsigned char* byte_array = static_cast<unsigned char*>( a_host_pointer );
#if defined( SMILEI_ACCELERATOR_GPU_OMP )
#pragma omp target exit data map( from  : byte_array [0:a_count * an_object_size] )
#elif defined( SMILEI_ACCELERATOR_GPU_OACC )
...
unsigned char* byte_array = static_cast<unsigned char*>( a_host_pointer );
#if defined( SMILEI_ACCELERATOR_GPU_OMP )
#pragma omp target exit data map( delete  : byte_array [0:a_count * an_object_size] )
#elif defined( SMILEI_ACCELERATOR_GPU_OACC )
