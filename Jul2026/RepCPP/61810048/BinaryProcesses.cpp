...
void BinaryProcesses::calculate_debye_length( Params &params, Patch *patch )
{
    ...
    #pragma acc parallel loop gang worker num_workers(2) vector_length(32)  copyout( debye2_ptr[:nbin] )  copyin( cellVolume, nspec, mass[:nspec], last_index_ptr[:nspec],  weight_ptr[:nspec], charge_ptr[:nspec], px_ptr[:nspec], py_ptr[:nspec], pz_ptr[:nspec] )
#elif defined( SMILEI_ACCELERATOR_GPU_OMP )
    #pragma omp target teams distribute thread_limit(32) map( from: debye2_ptr[:nbin] )  map( to: cellVolume, nspec, mass[:nspec], last_index_ptr[:nspec],  weight_ptr[:nspec], charge_ptr[:nspec], px_ptr[:nspec], py_ptr[:nspec], pz_ptr[:nspec] )
#endif
...
void BinaryProcesses::apply( Params &params, Patch *patch, int itime, vector<Diagnostic *> &localDiags )
{
    ...
    #pragma acc parallel loop gang vector_length(32) firstprivate(rand) private(D, np1, np2, shuffler) copyin( cellVolume, delta_t, nspec1, nspec2,/* sg1_ptr[:nspec1], sg2_ptr[:nspec2],*/  screening_group_size, screening_Z_ptr[:screening_group_size], lTF_ptr[:screening_group_size],  mass1[:nspec1], mass2[:nspec2], debye2_ptr[:nbin],  last_index1_ptr[:nspec1], weight1_ptr[:nspec1], charge1_ptr[:nspec1], px1_ptr[:nspec1], py1_ptr[:nspec1], pz1_ptr[:nspec1],  last_index2_ptr[:nspec2], weight2_ptr[:nspec2], charge2_ptr[:nspec2], px2_ptr[:nspec2], py2_ptr[:nspec2], pz2_ptr[:nspec2] )
#elif defined( SMILEI_ACCELERATOR_GPU_OMP )
    ...
    #pragma omp target teams distribute thread_limit(32) firstprivate(rand, shuffler) private(D, np1, np2)  map( to: cellVolume, delta_t, nspec1, nspec2,/* sg1_ptr[:nspec1], sg2_ptr[:nspec2],*/  screening_group_size, screening_Z_ptr[:screening_group_size], lTF_ptr[:screening_group_size],  mass1[:nspec1], mass2[:nspec2], debye2_ptr[:nbin],  last_index1_ptr[:nspec1], weight1_ptr[:nspec1], charge1_ptr[:nspec1], px1_ptr[:nspec1], py1_ptr[:nspec1], pz1_ptr[:nspec1],  last_index2_ptr[:nspec2], weight2_ptr[:nspec2], charge2_ptr[:nspec2], px2_ptr[:nspec2], py2_ptr[:nspec2], pz2_ptr[:nspec2] )
#else
    uint32_t np1[nspec1], np2[nspec2];
#endif
