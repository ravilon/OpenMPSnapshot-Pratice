...
#pragma omp target is_device_ptr( /* to: */                                          position_x /* [istart_pack:current_pack_size] */,  position_y /* [istart_pack:current_pack_size] */,  position_z /* [istart_pack:current_pack_size] */ )
#pragma omp teams distribute parallel for
#elif defined( SMILEI_ACCELERATOR_GPU_OACC )
#pragma acc parallel present( iold [0:3 * nparts],      deltaold [0:3 * nparts],  Sx0 [0:kTmpArraySize],    Sy0 [0:kTmpArraySize],    Sz0 [0:kTmpArraySize],    Sx1 [0:kTmpArraySize],    Sy1 [0:kTmpArraySize],    Sz1 [0:kTmpArraySize],    DSx [0:kTmpArraySize],    DSy [0:kTmpArraySize],    DSz [0:kTmpArraySize] )   deviceptr( position_x,                              position_y,                              position_z )
...
#if defined( SMILEI_ACCELERATOR_GPU_OMP )
#pragma omp target is_device_ptr( /* to: */                                      charge /* [istart_pack:current_pack_size] */,  weight /* [istart_pack:current_pack_size] */ )
#pragma omp teams distribute parallel for
#elif defined( SMILEI_ACCELERATOR_GPU_OACC )
#pragma acc parallel present( iold [0:3 * nparts],      Jx [0:Jx_size],          Sy0 [0:kTmpArraySize],    Sz0 [0:kTmpArraySize],    DSy [0:kTmpArraySize],    DSz [0:kTmpArraySize],    sumX [0:kTmpArraySize] )  deviceptr( charge, weight ) vector_length( 8 )
...
#pragma omp teams distribute parallel for
#elif defined( SMILEI_ACCELERATOR_GPU_OACC )
#pragma acc parallel present( DSy [0:kTmpArraySize],  sumX [0:kTmpArraySize] )
...
#pragma omp teams distribute parallel for
#elif defined( SMILEI_ACCELERATOR_GPU_OACC )
#pragma acc parallel present( iold [0:3 * nparts],      Jy [0:Jy_size],          Sx0 [0:kTmpArraySize],    Sz0 [0:kTmpArraySize],    DSx [0:kTmpArraySize],    DSz [0:kTmpArraySize],    sumX [0:kTmpArraySize] )  deviceptr( charge, weight ) vector_length( 8 )
...
#pragma omp teams distribute parallel for
#elif defined( SMILEI_ACCELERATOR_GPU_OACC )
#pragma acc parallel present( DSz [0:kTmpArraySize],  sumX [0:kTmpArraySize] )
...
#pragma omp teams distribute parallel for
#elif defined( SMILEI_ACCELERATOR_GPU_OACC )
#pragma acc parallel present( iold [0:3 * nparts],      Jz [0:Jz_size],          Sx0 [0:kTmpArraySize],    Sy0 [0:kTmpArraySize],    DSx [0:kTmpArraySize],    DSy [0:kTmpArraySize],    sumX [0:kTmpArraySize] )  deviceptr( charge, weight )
...
#pragma omp teams distribute parallel for
#elif defined( SMILEI_ACCELERATOR_GPU_OACC )
#pragma acc parallel present( iold [0:3 * nparts],      deltaold [0:3 * nparts],  Sx1 [0:kTmpArraySize],    Sy1 [0:kTmpArraySize],    Sz1 [0:kTmpArraySize] )   deviceptr( position_x,                              position_y,                              position_z )
...
#pragma omp teams distribute parallel for
#elif defined( SMILEI_ACCELERATOR_GPU_OACC )
#pragma acc parallel present( iold [0:3 * nparts],  rho [0:rho_size],           Sx1 [0:kTmpArraySize],      Sy1 [0:kTmpArraySize],      Sz1 [0:kTmpArraySize])      deviceptr( charge, weight )
#pragma acc loop gang worker
#endif
for( int ipart=istart_pack ; ipart<iend_pack; ipart++ ) {
