...
void internal_inf( Species *species, int imin, int imax, int direction, double limit_inf, double /*dt*/, std::vector<double> &/*invgf*/, Random * /*rand*/, double &energy_change )
{
    ...
    #pragma omp target is_device_ptr( /* to: */                            position /* [imin:imax - imin] */ )  is_device_ptr( /* tofrom: */                                       cell_keys /* [imin:imax - imin] */ )
                          ...
                          double& energy_change )
{
    ...
    #pragma omp target           is_device_ptr( position, momentum_x, momentum_y, momentum_z, charge, weight, cell_keys ) map( tofrom  : change_in_energy )
