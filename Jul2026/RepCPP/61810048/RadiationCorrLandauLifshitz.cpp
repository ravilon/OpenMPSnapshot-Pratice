...
#pragma acc parallel  present(Ex[istart_offset:np],  Ey[istart_offset:np],  Ez[istart_offset:np],  Bx[istart_offset:np],  By[istart_offset:np],  Bz[istart_offset:np])  deviceptr(momentum_x,momentum_y,momentum_z,charge,weight,chi)
{
...
#pragma omp target defaultmap( none )                                      map( to                                                                : Ex [istart_offset:np],                             Ey [istart_offset:np],                             Ez [istart_offset:np],                             Bx [istart_offset:np],                             By [istart_offset:np],                             Bz [istart_offset:np],                             map( to                                                            : istart, iend, ipart_ref,                          one_over_mass_square, dt_ )                           is_device_ptr( /* to: */                                       charge /* [istart:np] */ )         is_device_ptr( /* tofrom: */                               momentum_x /* [istart:np] */,  momentum_y /* [istart:np] */,  momentum_z /* [istart:np] */,  weight /* [istart:np] */,  chi /* [istart:np] */ )
#pragma omp            teams
