...
namespace acc {
    ...
    #pragma omp target is_device_ptr( /* to: */                                          charge /* [istart_pack:current_pack_size] */,  weight /* [istart_pack:current_pack_size] */,  position_x /* [istart_pack:current_pack_size] */,  position_y /* [istart_pack:current_pack_size] */,  position_z /* [istart_pack:current_pack_size] */ )
    #pragma omp teams distribute parallel for
#elif defined( SMILEI_ACCELERATOR_GPU_OACC )
    #pragma acc parallel present( iold [0:3 * nparts],      deltaold [0:3 * nparts],  Jx[0:Jx_size],  Jy[0:Jy_size],  Jz[0:Jz_size]  )  deviceptr( position_x,                              position_y,                              position_z, charge, weight )
...
//            const int linindex2 = iold[0]*yz_size2+iold[1]*z_size2+iold[2];
    ...
    #pragma omp teams distribute parallel for
#elif defined( SMILEI_ACCELERATOR_GPU_OACC )
    #pragma acc parallel present( iold [0:3 * nparts],      deltaold [0:3 * nparts],  rho[0:rho_size]  )  deviceptr( position_x,                              position_y,                              position_z, charge, weight )
