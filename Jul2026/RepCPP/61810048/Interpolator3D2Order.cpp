...
void Interpolator3D2Order::fieldsWrapper( ElectroMagn *EMfields, Particles &particles, SmileiMPI *smpi, int *istart, int *iend, int ithread, unsigned int, int )
{
    ...
    #pragma omp target map( to                                                  : i_domain_begin, j_domain_begin, k_domain_begin )  is_device_ptr( /* to: */                                                position_x /* [first_index:npart_range_size] */,         position_y /* [first_index:npart_range_size] */,         position_z /* [first_index:npart_range_size] */ )
    ...
    #pragma acc parallel present(ELoc [first_index:interpolation_range_size],   BLoc [first_index:interpolation_range_size],   iold [first_index:interpolation_range_size],   delta [first_index:interpolation_range_size],  Ex3D [0:sizeofEx],                             Ey3D [0:sizeofEy],                             Ez3D [0:sizeofEz],                             Bx3D [0:sizeofBx],                             By3D [0:sizeofBy],                             Bz3D [0:sizeofBz])                             deviceptr(position_x,                                                   position_y,                                                   position_z)                                                   copyin(d_inv_[0:3])
    ...
    #pragma acc update device(this)
    size_t interpolation_range_size = ( last_index + 2 * nparts ) - first_index;
    #pragma acc parallel present(ELoc [first_index:interpolation_range_size],   BLoc [first_index:interpolation_range_size],   BLocyBTIS3 [first_index:interpolation_range_size], BLoczBTIS3 [first_index:interpolation_range_size], iold [first_index:interpolation_range_size],   delta [first_index:interpolation_range_size],  Ex3D [0:sizeofEx],                             Ey3D [0:sizeofEy],                             Ez3D [0:sizeofEz],                             Bx3D [0:sizeofBx],                             By3D [0:sizeofBy],                             Bz3D [0:sizeofBz],                             By3DBTIS3 [0:sizeofEz],                      Bz3DBTIS3 [0:sizeofEy])                      deviceptr(position_x,                                                   position_y,                                                   position_z)                                                   copyin(d_inv_[0:3])
