...
inline __both__ vec_t(const sycl::float2 v) : x(v.x()), y(v.y()) {}
inline __both__ vec_t(const sycl::int2 v) : x(v.x()), y(v.y()) {}
inline __both__ vec_t(const sycl::uint2 v) : x(v.x()), y(v.y()) {}

inline __both__ operator sycl::float2() const
{
return make_float2(x, y);
}
inline __both__ operator sycl::int2() const
{
return make_int2(x, y);
}
inline __both__ operator sycl::uint2() const
{
...
#if defined(SYCL_LANGUAGE_VERSION)
inline __both__ vec_t(const sycl::int3 &v) : x(v.x()), y(v.y()), z(v.z()) {}
inline __both__ vec_t(const sycl::uint3 &v) : x(v.x()), y(v.y()), z(v.z()) {}
inline __both__ vec_t(const sycl::float3 &v) : x(v.x()), y(v.y()), z(v.z()) {}
inline __both__ operator sycl::float3() const
{
return sycl::float3((float)x, (float)y, (float)z);
}
inline __both__ operator sycl::int3() const
{
return sycl::int3(x, y, z);
}
inline __both__ operator sycl::uint3() const
{
return sycl::uint3(x, y, z);
}
#endif
...
#if defined(SYCL_LANGUAGE_VERSION)
inline __both__ vec_t(const sycl::float4 &v)
: x(v.x()), y(v.y()), z(v.z()), w(v.w()) {}
inline __both__ vec_t(const sycl::int4 &v)
: x(v.x()), y(v.y()), z(v.z()), w(v.w()) {}
inline __both__ operator sycl::float4() const
{
return sycl::float4(x, y, z, w);
}
inline __both__ operator sycl::int4() const
{
return sycl::int4(x, y, z, w);
}
#endif
/*! construct 3-vector from 3-vector of another type */
template<typename OT>
