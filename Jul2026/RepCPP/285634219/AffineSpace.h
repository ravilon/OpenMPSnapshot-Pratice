...
#define ScalarT typename L::vector_t::scalar_t
  ...
  struct GDT_INTERFACE AffineSpaceT
  {
    ...
    inline __both__ AffineSpaceT           ( const L           & other ) { l = other  ; p = VectorT(zero); }
    ...
    inline __both__ const AffineSpaceT inverse() const 
    { 
      const auto inv = l.inverse();
      return AffineSpaceT(inv, -xfmPoint(inv,p));
    }
    ...
    inline __both__ AffineSpaceT( ZeroTy ) : l(zero), p(zero) {}
    inline __both__ AffineSpaceT( OneTy )  : l(one),  p(zero) {}

    /*! return matrix for scaling */
    static inline __both__ AffineSpaceT scale(const VectorT& s) { return L::scale(s); }

    /*! return matrix for translation */
    static inline __both__ AffineSpaceT translate(const VectorT& p) { return AffineSpaceT(one,p); }

    /*! return matrix for rotation, only in 2D */
    static inline __both__ AffineSpaceT rotate(const ScalarT& r) { return L::rotate(r); }

    /*! return matrix for rotation around arbitrary point (2D) or axis (3D) */
    static inline __both__ AffineSpaceT rotate(const VectorT& u, const ScalarT& r) { return L::rotate(u,r); }

    /*! return matrix for rotation around arbitrary axis and point, only in 3D */
    static inline __both__ AffineSpaceT rotate(const VectorT& p, const VectorT& u, const ScalarT& r) { return translate(+p) * rotate(u,r) * translate(-p);  }

    /*! return matrix for looking at given point, only in 3D; right-handed coordinate system */
    static inline __both__ AffineSpaceT lookat(const VectorT& eye, const VectorT& point, const VectorT& up) {
  ...
  template<typename L> inline __both__ AffineSpaceT<L> operator -( const AffineSpaceT<L>& a ) { return AffineSpaceT<L>(-a.l,-a.p); }
  template<typename L> inline __both__ AffineSpaceT<L> operator +( const AffineSpaceT<L>& a ) { return AffineSpaceT<L>(+a.l,+a.p); }
  template<typename L> inline __both__ AffineSpaceT<L>        rcp( const AffineSpaceT<L>& a ) { L il = rcp(a.l); return AffineSpaceT<L>(il,-(il*a.p)); }

  ////////////////////////////////////////////////////////////////////////////////
  // Binary Operators
  ////////////////////////////////////////////////////////////////////////////////

  template<typename L> inline __both__ AffineSpaceT<L> operator +( const AffineSpaceT<L>& a, const AffineSpaceT<L>& b ) { return AffineSpaceT<L>(a.l+b.l,a.p+b.p); }
  template<typename L> inline __both__ AffineSpaceT<L> operator -( const AffineSpaceT<L>& a, const AffineSpaceT<L>& b ) { return AffineSpaceT<L>(a.l-b.l,a.p-b.p); }
  ...
  template<typename L> inline __both__ AffineSpaceT<L> operator /( const AffineSpaceT<L>& a, const AffineSpaceT<L>& b ) { return a * rcp(b); }
  template<typename L> inline __both__ AffineSpaceT<L> operator /( const AffineSpaceT<L>& a, const ScalarT        & b ) { return a * rcp(b); }

  template<typename L> inline __both__ AffineSpaceT<L>& operator *=( AffineSpaceT<L>& a, const AffineSpaceT<L>& b ) { return a = a * b; }
  template<typename L> inline __both__ AffineSpaceT<L>& operator *=( AffineSpaceT<L>& a, const ScalarT        & b ) { return a = a * b; }
  template<typename L> inline __both__ AffineSpaceT<L>& operator /=( AffineSpaceT<L>& a, const AffineSpaceT<L>& b ) { return a = a / b; }
  template<typename L> inline __both__ AffineSpaceT<L>& operator /=( AffineSpaceT<L>& a, const ScalarT        & b ) { return a = a / b; }
  ...
  template<typename L> inline __both__ bool operator ==( const AffineSpaceT<L>& a, const AffineSpaceT<L>& b ) { return a.l == b.l && a.p == b.p; }
  template<typename L> inline __both__ bool operator !=( const AffineSpaceT<L>& a, const AffineSpaceT<L>& b ) { return a.l != b.l || a.p != b.p; }
  ...
  template<> inline __both__ AffineSpace2f AffineSpace2f::rotate(const vec2f& p, const float& r)
