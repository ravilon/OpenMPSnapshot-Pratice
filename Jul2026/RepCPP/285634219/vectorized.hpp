...
struct IOType<bool, 8> {
  typedef sycl::int2 Type;
};
template <>
struct IOType<bool, 16> {
  typedef sycl::int4 Type;
};
template <>
...
struct IOType<uint8_t, 8> {
  typedef sycl::uint2 Type;
};
template <>
struct IOType<uint8_t, 16> {
  typedef sycl::uint4 Type;
};
template <>
...
template <> struct IOType<sycl::half, 1> {
  typedef sycl::half Type;
};
template <> struct IOType<sycl::half, 2> {
  typedef sycl::half2 Type;
};
template <> struct IOType<sycl::half, 4> {
  typedef sycl::uint2 Type;
};
template <> struct IOType<sycl::half, 8> {
  typedef sycl::uint4 Type;
};
template <> struct IOType<sycl::half2, 1> {
  typedef sycl::half2 Type;
};
template <> struct IOType<sycl::half2, 2> {
  typedef sycl::uint2 Type;
};
template <> struct IOType<sycl::half2, 4> {
  typedef sycl::uint4 Type;
};
template <>
...
struct IOType<float, 2> {
  typedef sycl::float2 Type;
};
template <>
struct IOType<float, 4> {
  typedef sycl::float4 Type;
};
template <>
...
struct TxN_t {
  ...
  auto* vectorized_data() { return reinterpret_cast<io_t*>(val.data); }
