...
#pragma omp parallel default(none) firstprivate(length, allocator)              shared(coeffs, terms, sv, sum, ex)
        {
...
#pragma omp parallel default(none) firstprivate(length)                         shared(coeffs, terms, sv, sum, ex)
        {
