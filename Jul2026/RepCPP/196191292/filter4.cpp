...
int main(int argc, char** argv) {
	...
	// sonuclar verecek ve yanlis calisacak. Private olmayan degiskenler varsaylan olarak shared tanimlidir.
	
	nThreads = omp_get_num_threads();
	
	#pragma omp for collapse(2) //pragma for varsaylan olarak ilk donguyu 
