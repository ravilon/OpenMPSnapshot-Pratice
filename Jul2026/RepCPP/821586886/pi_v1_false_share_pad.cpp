...
#define PAD 8  // Assuming 64bit L1 cache line. //#of double precision words in a cache line
// But this trick makes the alogrithm not portable as we have to know L1 cache line size of each machine we deply the code.
...
int main(){
    ...
    double pi=0, sum[NUM_THREADS][PAD] = {0.0}; // Pad the array such that each value is in different cache line.
