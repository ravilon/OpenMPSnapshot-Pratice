...
if (cudaMalloc((void **)&ncomponents, 1 * sizeof(unsigned)) != cudaSuccess) exit(1);
if (cudaMalloc((void **)&complen, nelements * sizeof(unsigned)) != cudaSuccess) exit(1);
if (cudaMalloc((void **)&ele2comp, nelements * sizeof(unsigned)) != cudaSuccess) exit(1);
}
