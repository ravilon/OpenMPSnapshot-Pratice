...
//use multiple threads to convert single list of word into list of key value pair
...
void wordCount() {
    ...
    //creating vector full of chunked words
    vector<string> wordVector;
    wordVector = InputReader();
    //chunked words turned into pair list
    vector<thread> threadVector;
    //vector for storing unique pairs with counted values
