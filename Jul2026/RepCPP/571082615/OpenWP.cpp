...
// Заполнение массивов параллельно с использованием FOR
...
// Сложение двух массивов параллельно с использованием цикла FOR
...
// Сложение двух массивов параллельно с использованием секций
...
// Сумма элементов маасива параллельно с использованием редукторов
...
// Сумма элементов массива параллельно с использованием крит. секций
...
void test_functions(void** Functions, std::string(Function_names)[7])
{
	...
	// Переменная размерность одномерных массивов для исследований
	for (int size = 100000; size <= 250000; size += 50000)
	{
		...
		// Массив для суммы первого и второго массивов
		double* arr_sum = new double[size];

		// Переменное число потоков
		for (int threads = 1; threads <= 4; threads++)
		{
			//Установка числа потоков
			omp_set_num_threads(threads);

			// Исследование 5 действий
			for (int j = 0; j < 5; j++)
			{
...
int main()
{
	...
	//Объявление массива названий функций
